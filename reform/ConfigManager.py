...
class ConfigManager:
	...
	def auto_generate_default_config(self):
		...
		processed_files = set()
		for current_dir, dirs, files in os.walk(self.projects_dir):
            dir_prefix = os.path.commonpath([self.projects_dir, current_dir])
			...
			default_config['projects'][current_dir] = self.auto_generate_directory(relative_current_dir)
	            ...
	            for file_name in files:
	                ...
	                with open(in_file_path, 'r') as in_file:
	                    ...
	                    try:
	                        ...
	                        default_config.append(parsed_data)
	    else:
